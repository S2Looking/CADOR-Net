...
#SL from model.roi_layers import nms
...
def parse_args():
  ...
  """
  parser = argparse.ArgumentParser(description='Test a CADOR network')
  ...
  parser.add_argument('--cuda', dest='cuda',
                      ...
                      default = 1,  #SL Expected all tensors to be on the same device
                      action='store_true')
...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      args.imdbval_name = "voc_2012_val" #"voc_2012_val"
  ...
  #load_name_fcn = os.path.join(input_dir, \
  #'fcn-resnet_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
  #model_fcn.load_state_dict(torch.load(load_name_fcn))
  ...
  fasterRCNN_FCN.load_state_dict(checkpoint['model'])
  ...
  for i in range(num_images):
      ...
      if vis:
          ...
          #cv2.waitKey(0)
          cv2.imwrite(os.path.join(output_dir,os.path.basename(imdb.image_path_at(i))
                                   .replace('.png','_predict.jpg')), im2show)
